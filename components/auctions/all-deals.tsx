...
function DealsPage() {
  ...
  const FilterSidebar = () => (
    <div className="space-y-6 bg-white p-4 sm:p-5 rounded-lg shadow-sm w-full max-w-full lg:max-w-[300px]">
      {/* Categories */}
      <div>
        <h3 className="mb-3 text-lg font-semibold text-[var(--site-button-text)] sm:mb-4 sm:text-xl lg:text-[20px]">
          Categories
        </h3>
        {isLoadingCategories ? (
              ...
              <div key={category._id} className="flex items-center space-x-3">
                ...
                <div className="flex items-center gap-2">
                  <Label
                    ...
                    className="cursor-pointer text-sm font-medium text-[#48616D] sm:text-base lg:text-lg"
                  >
            ...
            <DropdownMenuTrigger asChild>
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="cursor-pointer text-sm font-medium text-[#48616D] sm:text-base lg:text-lg">
                  ...
                  {filteredDealsData.length > 0 ? (
                    ...
                    <div className="col-span-full text-center py-10">
                      <p className="text-gray-500">
                        No Walk Throughz matched your filters.
                      </p>
                    </div>
                  )}
                </div>
